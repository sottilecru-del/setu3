...
const App: React.FC = () => {
  ...
  return (
    <div className="relative w-[375px] h-[812px] bg-[#fdf8f2] rounded-[60px] shadow-2xl overflow-hidden border-[8px] border-black select-none">
      ...
      <div className="absolute bottom-2 left-1/2 -translate-x-1/2 w-32 h-1 bg-black rounded-full opacity-20"></div>
    </div>
  );
};
